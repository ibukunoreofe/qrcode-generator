...
/**
 * Generates a QR code with a logo in the center and saves it to the file system.
 ...
 * @returns {Promise<string>} - The file path of the saved QR code.
 */
async function generateQRCodeWithLogo(text, format = 'png', pixel = 300, logoPath) {
    try {
